                                                    ...
                                                    this.state.data.map((elem, i) => (
                                                        <tr key={i}>
                                                            ...
                                                            <td>
                                                                ...
                                                                <br />
                                                                {
                                                                    Object.keys(elem.assignment_submissions).length ? <Badge pill variant="info" style={{ width: '100%', padding: 10 }}>Already Submitted</Badge> : new Date(elem.submission_date) < new Date() ? <Badge pill variant="danger" style={{ width: '100%', padding: 10 }}>Late</Badge> : 
